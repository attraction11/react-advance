...
class OutAssetPackage extends Component {
    ...
    render() {
        ...
        let childPackage = [];
        outAssetPackage.outPackageList.forEach((item,key)=>{
            for(let attr in item){
                childPackage.push(
                    <div className={"item"}>
                        ...
                        <div className={"line"}>
                            <div className={"value"}>{common.toRate(item[attr],2)}</div>
                        </div>
                    </div>
                );
            }
      ...
      return (
        ...
        <div className={"fieldArea"} style={{paddingLeft:20,justifyContent:'flex-start'}}>
            {childPackage}
        </div>
